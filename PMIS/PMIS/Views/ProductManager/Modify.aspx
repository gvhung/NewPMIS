...
<body>
    ...
    <div>
        <table>
            <tr>
                <th>项目名：</th><td><input type="text" id="pm_TPName" /></td>
                <th>负责人：</th><td><input type="text" id="pm_TPLead" onchange="IzXmEq()" />
                <input type="hidden" id="pm_TPLeadH"/>
                </td>
            </tr>
            <tr>
...
<a class="button" id="buttonUpload" onclick="ajaxFileUpload();">上传</a><input type="hidden" id="filePath"/></td>
            ...
            <tr>
                <td><a href="javascript:void(0)" onclick="Save()">保存</a></td>
            </tr>
        </table>
    </div>
    <div id="dlg" style="display: none">
        <div id="content"></div>
        <div><a id="Ok" onclick="btnOkClick()">确定</a></div>
    </div>
</body>
...
<script src="../../Scripts/View/ProductManager/modify.js" type="text/javascript"></script>
</html>
